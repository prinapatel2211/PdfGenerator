class UsersController < ApplicationController
  ...
  def pdf_generate
    respond_to do |format|
      format.html
      format.pdf do
        render pdf: 'show', layout: 'pdf', page_size: 'Letter', disposition: 'attachment', margin: { top: 0, bottom: 0, left: 0, right: 0 }
      end
    end
  end
  ...
  def user_params
    params.require(:user).permit(:designation, :name, :email, :address, :contact_no, :company_name, :website,
